...
const teamMembers = [ // prettier-ignore
  {
    ...
    howStarted: `As a mostly only child (my brother is 10 years older than me and had enough hobbies of his own!) I was always fascinated by board games but didn't have many chances to play. I ended up spending hours and hours poring over the rulebooks or coming up with my own rules. Whenever I did have family or friends over, they were always the first thing I'd try to get people to play. I sort of forgot about board games until I was living in Spain without internet for a month, picked up Terraforming Mars on a whim and it absolutely blew me away compared to the games I'd played growing up. It's cute now looking back that I probably played that at least 10 times before even thinking about getting another one, but after that it was off to the races! I was fascinated by the range, and honestly I still love thinking about the systems side of games and how many completely different experiences you can get from some components and a shared set of rules.`,
    top3Games: [
      {
        name: "Root",
