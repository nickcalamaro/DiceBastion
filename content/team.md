...
const teamMembers = [ // prettier-ignore
  {
    ...
    howStarted: `As a mostly only child (my brother is 10 years older than me and had enough hobbies of his own!) I was always fascinated by board games but didn't have many chances to play. I ended up spending hours and hours poring over the rulebooks or coming up with my own rules. Whenever I did have family or friends over, they were always the first thing I'd try to get people to play, usually combining a chess board with pieces from other games to try and recreate the stories and mechanics of the video games I was obsessed with. I sort of forgot about board games until I picked up a copy of Terraforming Mars on a whim and it absolutely blew me away compared to the games I'd played growing up. With just a board, a stack of cards and some cubes, you were able to tell entire stories and create an engine that really felt like having a planet-sized impact. It's cute now looking back that I probably played that at least 10 times before even thinking about getting another game, but after that it was off to the races! I'm still fascinated by the range of feelings board games can inspire and how much of a system you can build with just some components and a shared set of rules.`,
    top3Games: [
      {
        name: "Root",
      ...
      {
        name: "Sail",
        description: `<p>For something lighter, and a sign of just how diverse board games can be. Sail is an incredibly simple, cooperative trick-taking game at its core: one of you will take the lead and play a card from your hand. Your partner will then play their own card and you'll perform different actions depending on the combination you play: sailing towards whoever won the trick, fighting back the deadly kraken that damages your ship each round or, if you can play your cards just right, get some help from mermaids to sail straight ahead. This is a lot easier than it sounds though because the sea is filled with obstacle and most importantly, you're not allowed to share information about any of the cards you have. Since players are forced to play cards of the same suit when possible, you'll have to try and play the right cards to cut down your hand and take some risks about what your partner has in their's.</p><p>Sail is played as a campaign and going through the increasingly difficult challenges with Jen was such an awesome experience. A huge part of board games is the feelings they create, and there's nothing like the worry about whether you and your partner are on the same page about your plans, and then the feeling of excitement when the cards line up just right and you manage to scrape by to the end of a mission!</p>`
      }
    ],
