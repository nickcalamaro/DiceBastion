...
Blog pages served from `/posts/*` are pre-rendered by `bgg-bunny/blog-html.ts` — edit that file, rebuild `bgg-bunny/dist/blog.js`, and republish posts to update CDN HTML.
