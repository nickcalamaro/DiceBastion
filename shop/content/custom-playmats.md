...
<h1 id="playmat-heading" class="playmat-page-title playmat-page-title--banner">
<img src="/img/playmats/banner.png" alt="Custom playmats by Jen" width="1600" height="520" class="playmat-banner" decoding="async" fetchpriority="high">
</h1>
<p class="playmat-intro-lead">Our very own Jen designs and puts together custom playmats for all kinds of card games. These mats are perfect for showing off your favourite characters when playing your favourite game, or even for use as a deskmat or decoration. Share what you have in mind and they will work with you from the to design your perfect playmat that you can collect right from the club!</p>
</div>
<div class="playmat-process">
<h2>How a commission works</h2>
<p class="playmat-process-lead">We'll work with you to design your playmat and settle on a design you like before anything goes off to print.</p>
<div class="playmat-phases">
<div class="playmat-phase">
<span class="playmat-phase-label">Step 1</span>
<h3>Brief</h3>
<p>Send your ideas, references, and any text or motifs you want on the mat. We will confirm details and timeline by email and send a payment link for 50% of the cost.</p>
</div>
<div class="playmat-phase">
<span class="playmat-phase-label">Step 2</span>
<h3>First look</h3>
<p>We'll send you an initial design for you to review. Let us know what you think so we can keep what works, make changes, or go in a different direction.</p>
</div>
<div class="playmat-phase">
<span class="playmat-phase-label">Step 3</span>
<h3>Revisions</h3>
<p>We'll update the design based on your feedback. You get a second round of feedback to lock in the final version. If more changes are required after that we'll give you a quote to finish it off.</p>
</div>
<div class="playmat-phase">
...
<h2 class="card-header">Request a commission</h2>
...
<input type="text" id="playmat-name" class="form-input" required autocomplete="name" placeholder="Your full name">
</div>
<div class="form-group">
<label class="form-label" for="playmat-email">Email address</label>
...
<input type="text" id="playmat-hp" name="website" autocomplete="off" tabindex="-1" style="position:absolute;left:-9999px;opacity:0;" aria-hidden="true">
<div class="form-group">
<div class="form-label">Security check</div>
<div id="playmat-ts" data-sitekey="0x4AAAAAACAB4xlOnW3S8K0k" data-size="flexible"></div>
</div>
...
<div class="alert alert-success" style="margin-bottom: 1.25rem;">Thanks. Your request has been sent. We will get back to you at the email address you provided.</div>
<p style="color: rgb(var(--color-neutral-600)); margin: 0;">If you do not hear from us within a few days, email <a href="mailto:jen@dicebastion.com" class="link" style="color: rgb(var(--color-primary-600));">jen@dicebastion.com</a> with a short note and we will follow up.</p>
</div>
</div>
</section>
