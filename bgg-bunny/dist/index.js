...
async function createBoardGame(request) {
  try {
...
async function updateBoardGame(id, request) {
  try {
    const data = await request.json();
    ...
    await upsertGame({
      ...
      description: data.description !== void 0 ? data.description : current.description,
      short_description: data.short_description !== void 0 ? data.short_description : current.short_description,
      image_url: data.image_url !== void 0 ? data.image_url : current.image_url,
      thumbs: data.thumbs ?? Number(current.thumbs),
      post_date: data.post_date ?? current.post_date
    });
...
async function syncFromBGG() {
  ...
  try {
    ...
    const existingGames = /* @__PURE__ */ new Map();
...
async function fetchBGGDetails(gameId) {
...
async function uploadImageToBunny(imageUrl, gameId) {
  try {
